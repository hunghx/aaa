...
```mermaid
flowchart TD
    A["📢 Bước 1: Thông báo & chuẩn bị\n(T-14 ngày)\nHR gửi biểu mẫu, hướng dẫn"] 
    --> B["📝 Bước 2: Nhân viên tự đánh giá\n(T-10 ngày)\nViết minh chứng cho từng tiêu chí"]
    --> C["👥 Bước 3: Thu thập đánh giá 360°\n(T-7 ngày)\nĐồng nghiệp + Cấp dưới + Học viên"]
    --> D["👤 Bước 4: Quản lý đánh giá\n(T-5 ngày)\nCho điểm + Nhận xét + Đối chiếu minh chứng"]
    --> E["🤝 Bước 5: Họp 1-on-1\n(T-3 ngày)\nTrao đổi kết quả, ghi nhận đóng góp\nLắng nghe nguyện vọng phát triển"]
    --> F["🎯 Bước 6: Lập kế hoạch phát triển\n(T-1 ngày)\nĐặt mục tiêu kỳ tiếp theo\nCam kết hỗ trợ từ tổ chức"]
    --> G["✅ Bước 7: Phê duyệt & Ghi nhận\n(Ngày T)\nBGĐ duyệt + Công bố + Lưu hồ sơ\nThực hiện chính sách đãi ngộ"]
```
